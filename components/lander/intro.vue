  ...
  <section id="about">
    <div class="px-8 py-12 mx-auto md:px-12 lg:px-32 max-w-7xl lg:py-24">
      ...
      <ul class="grid grid-cols-1 mt-12 list-none md:grid-cols-2 gap-2 text-center" role="list">
        <li>
          <div class="p-8 rounded-3xl lg:p-10 bg-blue-50 h-full">
            <div
              class="rounded-full bg-white h-14 w-14 p-3 items-center inline-flex text-blue-500 mx-auto justify-center">
              <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"  width="100" height="100">
                <path
            ...
            <p class="text-2xl mt-4 font-display text-blue-900 lg:text-3xl">
              Declutter Your Tabs
            </p>
            <p class="mt-2 text-base text-slate-600">
              TabZen automatically identifies and hides distracting elements, allowing you to focus on the tabs and
              chords without visual clutter.
            </p>
          </div>
        </li>
        <li>
          <div class="p-8 rounded-3xl lg:p-10 bg-blue-50 h-full">
            <div
              class="rounded-full bg-white h-14 w-14 p-4 items-center inline-flex text-blue-500 mx-auto justify-center">
              <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" width="100" height="100">
                <path
            ...
            <p class="mt-2 text-base text-slate-600">
              With TabZen, your practice sessions and learning remain uninterrupted. No more frustrating pop-ups and
