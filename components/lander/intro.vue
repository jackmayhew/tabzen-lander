      ...
      <ul class="grid grid-cols-1 mt-12 list-none md:grid-cols-2 gap-2 text-center" role="list">
        <li>
          <div class="p-8 rounded-3xl lg:p-10 bg-blue-50 h-full">
            <div class="rounded-full bg-white h-14 w-14 p-3 items-center inline-flex text-blue-500 mx-auto justify-center">
        ...
        <li>
          <div class="p-8 rounded-3xl lg:p-10 bg-blue-50 h-full">
            <div class="rounded-full bg-white h-16 w-16 p-3 items-center inline-flex text-blue-500 mx-auto justify-center">
              <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" 
                xmlns="http://www.w3.org/2000/svg">
                <path
